...
const envSchema = z.object({
  ...
  IMAGE_DEFAULT_WIDTH: z.coerce.number().optional().default(1024),
  IMAGE_DEFAULT_HEIGHT: z.coerce.number().optional().default(1536),
  IMAGE_CHAPTER_WIDTH: z.coerce.number().optional().default(1024),
  IMAGE_CHAPTER_HEIGHT: z.coerce.number().optional().default(1536),
  IMAGE_COVER_WIDTH: z.coerce.number().optional().default(1024),
  IMAGE_COVER_HEIGHT: z.coerce.number().optional().default(1536),
