import { pgTable, uuid, timestamp, integer, varchar, jsonb, decimal, index } from "drizzle-orm/pg-core";
...
export const tokenUsageTracking = pgTable("token_usage_tracking", {
  ...
  authorIdCreatedAtIdx: index("token_usage_author_id_created_at_idx").on(table.authorId, table.createdAt),
