...
export class OpenAIImageService implements IImageGenerationService {
  ...
  constructor(config: OpenAIConfig) {
    ...
    this.model =
      config.model || process.env.OPENAI_BASE_MODEL || process.env.OPENAI_TEXT_MODEL || 'gpt-5.5';
    this.imageModel = config.imageModel || process.env.OPENAI_IMAGE_TOOL_MODEL || 'gpt-image-2';
